...
<?php echo CHtml::link('<i class="icon icon-cloud-upload icon-white"></i> Incluir Documento' , array('/projeto/createFile', 'id'=>$model->cod_projeto), array('class'=>'btn btn-small btn-primary', 'style'=>'text-decoration: none'))?>
